...
/**
 * The board class is used to store the state of the board during the game and control the addition of orbs to cells and the explosions.
 * <p>
 * It is also responsible for putting clusters of orbs on the grid and for their rotation while in the cell and translation of spheres while exploding.
 */
